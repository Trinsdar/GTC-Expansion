...
public class GTCExpansion {
	...
	public static final String DEPENDS = "required-after:ic2;required-after:ic2-classic-spmod;required-after:gtclassic@[1.0.7,);after:twilightforest@[3.9.984,);after:ic2c_extras;after:gravisuit@[1.0.8.1,)";
