...
public class GTCXBlockIndustrialBlastFurnace extends GTCXBlockTile {
    public GTCXBlockIndustrialBlastFurnace() {
        super("industrialblastfurnace", GTCXLang.INDUSTRIAL_BLAST_FURNACE, 3);
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
        ...
        NBTTagCompound nbt;
        if (tile instanceof GTCXTileMultiIndustrialBlastFurnace) {
            GTCXTileMultiIndustrialBlastFurnace ibf = (GTCXTileMultiIndustrialBlastFurnace) tile;
            if (stack.hasTagCompound()) {
                nbt = StackUtil.getNbtData(stack);
                if (nbt.getBoolean("Kanthal")) {
                    ibf.setKanthal(true);
