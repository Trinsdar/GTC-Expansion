...
public class GTCXContainerCentrifuge extends ContainerTileComponent<GTCXTileCentrifuge> {
	...
	public GTCXContainerCentrifuge(InventoryPlayer player, GTCXTileCentrifuge tile) {
		super(tile);
		for (int x = 0; x < 2; ++x) {
