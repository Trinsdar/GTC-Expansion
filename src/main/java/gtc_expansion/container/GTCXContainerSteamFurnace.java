...
public class GTCXContainerSteamFurnace extends ContainerTileComponent<GTCXTileSteamFurnace> {
    ...
    public GTCXContainerSteamFurnace(InventoryPlayer player, GTCXTileSteamFurnace tile) {
        super(tile);
