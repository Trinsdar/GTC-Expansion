...
public class GTCXContainerSteamMacerator extends ContainerTileComponent<GTCXTileSteamMacerator> {
    ...
    public GTCXContainerSteamMacerator(InventoryPlayer player, GTCXTileSteamMacerator tile) {
        super(tile);
