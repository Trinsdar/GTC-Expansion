...
public class GTCXContainerExtruder extends ContainerTileComponent<GTCXTileExtruder> {
    ...
    public GTCXContainerExtruder(InventoryPlayer player, GTCXTileExtruder tile) {
        super(tile);
