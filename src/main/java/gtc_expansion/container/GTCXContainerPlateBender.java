...
public class GTCXContainerPlateBender extends ContainerTileComponent<GTCXTilePlateBender> {
    ...
    public GTCXContainerPlateBender(InventoryPlayer player, GTCXTilePlateBender tile) {
        super(tile);
