...
public class GTCXContainerPlateCutter extends ContainerTileComponent<GTCXTilePlateCutter> {
    ...
    public GTCXContainerPlateCutter(InventoryPlayer player, GTCXTilePlateCutter tile) {
        super(tile);
