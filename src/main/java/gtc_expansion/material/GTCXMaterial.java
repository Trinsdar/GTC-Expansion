...
public class GTCXMaterial {
    ...
    public static final GTMaterial Antimony = setHeat(new GTMaterial(51,"Antimony", 1, 220, 220, 240, molten, smalldust, dust, tinydust, nugget, ingot, plate, stick, gear, blockMetal), 630);
    ...
    public static final GTMaterial Brass = setHeat(new GTMaterial("Brass", 1, 255, 180, 0, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull , pipeItem), 932);
    public static final GTMaterial Bronze = setHeat(new GTMaterial("Bronze", 1, 255, 128, 0, pipeFluid, molten, smalldust, nugget, plate, stick, gear, hull, turbineBlade), 913);
    ...
    public static final GTMaterial Constantan = setHeat(new GTMaterial("Constantan", 2, 227, 150, 128, pipeItem, dust, ingot, blockMetal, molten, smalldust, nugget, plate, stick),1210);
    public static final GTMaterial Copper = setHeat(new GTMaterial(29,"Copper", 180, 113, 61, molten, smalldust, nugget, plate, stick, gear),1085);
    ...
    public static final GTMaterial Gold = setHeat(new GTMaterial(79,"Gold", 1, 255, 255, 30, molten, smalldust, plate, stick, gear), 1064);
    ...
    public static final GTMaterial Iron = setHeat(new GTMaterial(26,"Iron", 1, 184, 184, 184, molten, smalldust, plate, stick, gear), 1538);
    ...
    public static final GTMaterial Lead = setHeat(new GTMaterial(82,"Lead", 140, 100, 140, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal), 327);
    public static final GTMaterial Magnalium = setHeat(new GTMaterial("Magnalium", 2, 200, 190, 255, molten, smalldust, dust, nugget, ingot, plate, stick, turbineBlade),600);
    public static final GTMaterial Magnesium = new GTMaterial(12,"Magnesium", 255, 200, 200, dustAll);
    public static final GTMaterial Manganese = setHeat(new GTMaterial(25,"Manganese", 2, 250, 235, 250, molten, smalldust, dust, tinydust, nugget, ingot, plate, blockMetal), 1246);
    ...
    public static final GTMaterial Nichrome = setHeat(new GTMaterial(-1,"Nichrome", 3, 205, 206, 246, false, molten, smalldust, dust, nugget, ingot, plate, stick, hotIngot), 1400);
    ...
    public static final GTMaterial Osmium = setHeat(new GTMaterial(76,"Osmium", 5, 50, 50, 255, false, molten, smalldust, dust, nugget, ingot, hotIngot, plate, stick, gear, blockMetal, tinydust), 3033);
    ...
    public static final GTMaterial RedAlloy = setHeat(new GTMaterial("RedAlloy", 1, 200, 0, 0, molten, smalldust, dust, ingot, plate, nugget, stick), 1600);
    ...
    public static final GTMaterial RefinedIron = setHeat(new GTMaterial("RefinedIron", 1, 220, 235, 235, stick, plate, gear, hull, molten), 1538);
    public static final GTMaterial Saltpeter = new GTMaterial("Saltpeter", 230, 230, 230, dustAll);
    public static final GTMaterial Silver = setHeat(new GTMaterial("Silver", 215, 225, 230, molten, smalldust, nugget, plate, stick, gear), 962);
    ...
    public static final GTMaterial StainlessSteel = setHeat(new GTMaterial(-1, "StainlessSteel", 3, 200, 200, 220, false, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull, pipeFluid), 1510);
    public static final GTMaterial Steel = setHeat(new GTMaterial(-1, "Steel", 2, 128, 128, 128, false, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull, pipeFluid, turbineBlade), 1371);
    ...
    public static final GTMaterial Tin = setHeat(new GTMaterial("Tin", 220, 220, 220, molten, smalldust, nugget, plate, stick, gear), 231);
    ...
    public static final GTMaterial Zinc = setHeat(new GTMaterial(30,"Zinc", 1, 250, 240, 240, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, tinydust), 419);

    public static void initMaterials(){
        GTMaterial.Aluminium.addFlags(metalFullWHull).setSmeltable(false);
        materialHeatMap.put(GTMaterial.Aluminium, 660);
        ...
        materialHeatMap.put(GTMaterial.Chrome, 2500);
        GTMaterial.Electrum.addFlags(metalFull);
        materialHeatMap.put(GTMaterial.Electrum, 1024);
        ...
        materialHeatMap.put(GTMaterial.Invar, 1427);
        ...
        materialHeatMap.put(GTMaterial.Iridium, 2466);
        ...
        materialHeatMap.put(GTMaterial.Nickel, 1453);
        ...
        materialHeatMap.put(GTMaterial.Platinum, 1768);
        GTMaterial.Plutonium.addFlags(smalldust, nugget, plate, molten);
        materialHeatMap.put(GTMaterial.Plutonium, 639);
        ...
        materialHeatMap.put(GTMaterial.Tungsten, 3422);
        GTMaterial.Uranium.addFlags(smalldust, molten);
        materialHeatMap.put(GTMaterial.Uranium, 1132);
