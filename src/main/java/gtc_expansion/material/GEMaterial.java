...
public class GEMaterial {
    ...
    static {
        ...
        Gold = new GTMaterial("Gold", 255, 255, 30, molten, smalldust, plate, stick, wire, gear);
        ...
        Iron = new GTMaterial("Iron", 184, 184, 184, molten, smalldust, plate, stick, gear, magnetic);
        Invar = new GTMaterial("Invar", 220, 220, 150, metalFull);
        Lazurite = new GTMaterial("Lazurite", 100, 120, 255, dustAll);
        Lead = new GTMaterial("Lead", 140, 100, 140, molten, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        Nickel = new GTMaterial("Nickel", 200, 200, 250, molten, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        Nichrome = new GTMaterial("Nichrome", 205, 206, 246, molten, smalldust, dust, nugget, ingot, plate, stick, coil);
        ...
        Platinum = new GTMaterial("Platinum", 255, 255, 200, false, molten, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        RedAlloy = new GTMaterial("RedAlloy", 200, 0, 0, molten, smalldust, dust, ingot, nugget, stick, wire);
        ...
        Silver = new GTMaterial("Silver", 215, 225, 230, molten, smalldust, nugget, plate, stick, wire, gear, foil);
        ...
        Steel = new GTMaterial("Steel", 128, 128, 128, molten, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull, magnetic);
        ...
        Tin = new GTMaterial("Tin", 220, 220, 220, molten, smalldust, nugget, plate, stick, wire, gear);
