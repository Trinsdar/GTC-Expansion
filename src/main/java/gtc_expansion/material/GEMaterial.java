...
public class GEMaterial {
    ...
    static {
        ...
        Tungsten = new GTMaterial("Tungsten", 50, 50, 50, molten, smalldust, dust, nugget, ingot, hotIngot, plate, stick, gear, blockMetal, tinydust, crushedore, crushedorePurified);
