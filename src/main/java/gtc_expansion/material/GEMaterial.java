...
public class GEMaterial {
    ...
    static {
        ...
        Aluminium = new GTMaterial("Aluminium", 128, 200, 240, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal, hull, foil);
        ...
        Bronze = new GTMaterial("Bronze", 230, 83, 34, smalldust, nugget, plate, stick, gear, hull);
        ...
        Constantan = new GTMaterial("Constantan", 196, 116, 77, smalldust, dust, nugget, ingot, plate, stick, coil);
        Copper = new GTMaterial("Copper", 180, 113, 61, smalldust, nugget, plate, stick, wire, gear, coil, foil);
        ...
        Gold = new GTMaterial("Gold", 255, 255, 30, smalldust, plate, stick, wire, gear);
        ...
        Iridium = new GTMaterial("Iridium", 255, 255, 255, false, smalldust, dust, nugget, ingot, hotIngot, gear, stick, blockMetal);
        Iron = new GTMaterial("Iron", 184, 184, 184, smalldust, plate, stick, gear, magnetic);
        Invar = new GTMaterial("Invar", 220, 220, 150, metalFull);
        Lazurite = new GTMaterial("Lazurite", 100, 120, 255, dustAll);
        Lead = new GTMaterial("Lead", 140, 100, 140, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        Manganese = new GTMaterial("Manganese", 250, 235, 250, smalldust, dust, nugget, ingot, plate, blockMetal);
        Marble = new GTMaterial("Marble", 200, 200, 200, dustAll);
        Netherrack = new GTMaterial("Netherrack", 200, 0, 0, smalldust);
        Nickel = new GTMaterial("Nickel", 200, 200, 250, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        Nichrome = new GTMaterial("Nichrome", 205, 206, 246, smalldust, dust, nugget, ingot, plate, stick, coil);
        ...
        Platinum = new GTMaterial("Platinum", 255, 255, 200, false,smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        RedAlloy = new GTMaterial("RedAlloy", 200, 0, 0, smalldust, dust, ingot, nugget, stick, wire);
        ...
        Silicon = new GTMaterial("Silicon", 60, 60, 80, fluid, smalldust, dust, nugget, ingot, plate, smallplate);
        Silver = new GTMaterial("Silver", 215, 225, 230, smalldust, nugget, plate, stick, wire, gear, foil);
        ...
        StainlessSteel = new GTMaterial("StainlessSteel", 200, 200, 220, false, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal);
        Steel = new GTMaterial("Steel", 128, 128, 128, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull, magnetic);
        ...
        Tin = new GTMaterial("Tin", 220, 220, 220, smalldust, nugget, plate, stick, wire, gear);
        Titanium = new GTMaterial("Titanium", 170, 143, 222, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull);
        Tungsten = new GTMaterial("Tungsten", 50, 50, 50, smalldust, dust, nugget, ingot, hotIngot, plate, stick, wire, gear, blockMetal);
        TungstenSteel = new GTMaterial("Tungstensteel", 100, 100, 160, smalldust, dust, nugget, ingot, hotIngot, plate, stick, gear, blockMetal);
