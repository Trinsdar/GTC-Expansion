...
public class GTMaterial2 extends GTMaterial{
    ...
    static {
        ...
        Aluminium = replaceMaterial(GTMaterial.Aluminium, new GTMaterial2("Aluminium", 128, 200, 240, 10.0F, 128, 2, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal, hull, foil));
        Andradite = new GTMaterial2("Andradite", 150, 120, 0, dustAll);
        Ashes = new GTMaterial2("Ashes", 192, 192, 192, dustAll);
        Basalt = replaceMaterial(GTMaterial.Basalt, new GTMaterial2("Basalt", 30, 20, 20, 5.0F, 0, 2, dustAll));
        ...
        Brass = new GTMaterial2("Brass", 255, 180, 0, 7.0F, 96, 1, metalFullWHull);
        Bronze = new GTMaterial2("Bronze", 230, 83, 34, 6.0F, 192, 2, smalldust, nugget, plate, stick, gear, hull);
        ...
        Copper = new GTMaterial2("Copper", 180, 113, 61, smalldust, nugget, plate, stick, wire, gear, coil, foil);
        ...
        Gold = new GTMaterial2("Gold", 255, 255, 30, 12.0F, 64, 2, smalldust, plate, stick, wire, gear);
        ...
        Iridium = replaceMaterial(GTMaterial.Iridium, new GTMaterial2("Iridium", 255, 255, 255, false, 6.0F, 5120, 4, smalldust, dust, nugget, ingot, hotIngot, gear, stick, blockMetal));
        Iron = new GTMaterial2("Iron", 184, 184, 184, 6.0F, 256, 2, smalldust, plate, stick, gear, magnetic);
        ...
        Lead = new GTMaterial2("Lead", 140, 100, 140, 8.0F, 64, 1, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        Nickel = new GTMaterial2("Nickel", 200, 200, 250, 6.0F, 64, 2, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal);
        ...
        Platinum = replaceMaterial(GTMaterial.Platinum, new GTMaterial2("Platinum", 255, 255, 200, false, 12.0F, 64, 2, smalldust, dust, nugget, ingot, plate, stick, wire, gear, blockMetal));
        Plutonium = replaceMaterial(GTMaterial.Plutonium, new GTMaterial2("Plutonium", 240, 50, 50, 6.0F, 512, 3, smalldust, dust, nugget, ingot, plate));
        ...
        RefinedIron = new GTMaterial2("RefinedIron", 220, 235, 235,6.0F, 384, 2, stick, plate, gear);
        ...
        Silver = new GTMaterial2("Silver", 215, 225, 230, 10.0F, 64, 2, smalldust, nugget, plate, stick, wire, gear, foil);
        ...
        StainlessSteel = new GTMaterial2("StainlessSteel", 200, 200, 220, false, 7.0F, 480, 2, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal);
        Steel = replaceMaterial(GTMaterial.Steel, new GTMaterial2("Steel", 128, 128, 128, 6.0F, 512, 2, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull, magnetic));
        ...
        Thorium = replaceMaterial(GTMaterial.Thorium, new GTMaterial2("Thorium", 0, 30, 0, false, 6.0F, 512, 2, smalldust, dust, nugget, ingot));
        Tin = new GTMaterial2("Tin", 220, 220, 220, smalldust, nugget, plate, stick, wire, gear);
        Titanium = replaceMaterial(GTMaterial.Titanium, new GTMaterial2("Titanium", 170, 143, 222, 8.0F, 2560, 3, smalldust, dust, nugget, ingot, plate, stick, gear, blockMetal, hull));
        Tungsten = replaceMaterial(GTMaterial.Tungsten, new GTMaterial2("Tungsten", 50, 50, 50, 8.0F, 5120, 3, smalldust, dust, nugget, ingot, hotIngot, plate, stick, wire, gear, blockMetal));
        TungstenSteel = new GTMaterial2("Tungstensteel", 100, 100, 160, 10.0F, 5120, 4, smalldust, dust, nugget, ingot, hotIngot, plate, stick, gear, blockMetal);
