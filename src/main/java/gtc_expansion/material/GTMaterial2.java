...
public class GTMaterial2 extends GTMaterial{
    ...
    static {
        ...
        Cobalt = new GTMaterial2("Cobalt", 80, 80, 250, 8.0F, 512, 4, metalBase);
        ...
        StainlessSteel = new GTMaterial2("StainlessSteel", 200, 200, 220, 7.0F, 480, 2, smalldust, dust, nugget, ingot, plate, stick, gear, block, casing);
