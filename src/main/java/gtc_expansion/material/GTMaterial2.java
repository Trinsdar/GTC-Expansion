...
public class GTMaterial2 extends GTMaterial{
    ...
    public static GTMaterialFlag gemBlock = GTMaterialFlag.GEMBLOCK;
    ...
    static {
        ...
        Aluminium = replaceMaterial(GTMaterial.Aluminium, new GTMaterial2("Aluminium", 128, 200, 240, 10.0F, 128, 2, smalldust, dust, nugget, ingot, plate, stick, wire, gear, block, casing, foil));
        ...
        Lead = new GTMaterial2("Lead", 140, 100, 140, 8.0F, 64, 1, smalldust, dust, nugget, ingot, plate, stick, wire, gear, block, casing);
        ...
        Platinum = new GTMaterial2("Platinum", 100, 180, 250, false, 12.0F, 64, 2, smalldust, dust, nugget, ingot, plate, stick, wire, gear, block, casing);
        ...
        StainlessSteel = new GTMaterial2("StainlessSteel", 200, 200, 220, false, 7.0F, 480, 2, smalldust, dust, nugget, ingot, plate, stick, gear, block, casing);
