...
public class GEToolMaterial {
    ...
    public static final ToolMaterial Steel = createToolMaterial(GEMaterial.Steel, 2, 6.0F, 512, 3.0F);
    public static final ToolMaterial TungstenSteel = createToolMaterial(GEMaterial.TungstenSteel, 4, 10.0F, 5120, 10.0F);
