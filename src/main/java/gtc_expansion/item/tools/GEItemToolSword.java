...
public class GEItemToolSword extends ItemSword
    ...
    public GEItemToolSword(GTMaterial mat, ToolMaterial tmat) {
        super(tmat);
        this.material = mat;
    ...
    public TextureAtlasSprite getTexture(int i) {
        return Ic2Icons.getTextures(GTCExpansion.MODID + "_materials")[23];
    }
    ...
    public TextureAtlasSprite getTexture(int var1, ItemStack var2) {
        return Ic2Icons.getTextures(GTCExpansion.MODID + "_materials")[23 + var1];
    }
