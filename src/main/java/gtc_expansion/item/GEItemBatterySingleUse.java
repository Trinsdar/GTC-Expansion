...
public class GEItemBatterySingleUse extends ItemIC2 implements ITexturedItem, IAdvancedTexturedItem {
    private ModelResourceLocation[] locations;
    int maxCharge;
    int tier;
    int id;
    public GEItemBatterySingleUse(String name, int maxCharge, int tier, int id) {
