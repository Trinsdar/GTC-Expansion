...
public class GTRecipeCentrifuge {
    ...
    public static void init(){
        ...
        GTTileCentrifuge.addRecipe(GTMaterialGen.getDust(GTMaterial2.RedRock, 16), 0, totalEu(2000), GTMaterialGen.getDust(GTMaterial2.Calcite, 8), GTMaterialGen.getDust(GTMaterial2.Flint, 4), GTMaterialGen.getDust(GTMaterial2.Clay, 4));
