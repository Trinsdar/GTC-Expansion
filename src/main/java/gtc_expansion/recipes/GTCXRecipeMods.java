...
public class GTCXRecipeMods {
    public static void init(){
        ...
        if (GTConfig.modcompat.compatIc2Extras && Loader.isModLoaded(GTValues.MOD_ID_IC2_EXTRAS)){
            ...
            GTRecipe.maceratorUtil("oreCassiterite", 1, GTMaterialGen.getModItem(GTValues.MOD_ID_IC2_EXTRAS, "tincrushedore", 4));
            ...
            GameRegistry.addSmelting(GTCXMaterialGen.getCrushedOre(GTCXMaterial.Cassiterite, 1), GTMaterialGen.getIngot(GTCXMaterial.Tin, 1), 0.5F);
            GameRegistry.addSmelting(GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Cassiterite, 1), GTMaterialGen.getIngot(GTCXMaterial.Tin, 1), 0.5F);
            ...
            GTRecipeCraftingHandler.overrideGTRecipe(GTValues.MOD_ID_IC2_EXTRAS, "shaped_tile.orewashingplant_" + recipeId, GTMaterialGen.getModItem(GTValues.MOD_ID_IC2_EXTRAS, "orewashingplant"), "PPP", "BMB", "cCc", 'P', GTCXRecipe.materialRefinedIron, 'B', Items.BUCKET, 'M', machineBlock, 'c', Ic2Items.carbonMesh, 'C', circuit);
