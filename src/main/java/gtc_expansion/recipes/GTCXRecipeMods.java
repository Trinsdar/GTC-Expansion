...
public class GTCXRecipeMods {
    public static void init(){
        ...
        if (GTConfig.modcompat.compatIc2Extras && Loader.isModLoaded(GTHelperMods.IC2_EXTRAS)){
            ...
            addCrushedOreRecipes(GTCXMaterial.Pyrite, GTCXMaterialGen.getTinyDust(GTCXMaterial.Sulfur, 1), GTCXMaterialGen.getTinyDust(GTCXMaterial.Phosphorus, 1));
            addCrushedOreRecipes(GTCXMaterial.Bauxite, GTCXMaterialGen.getTinyDust(GTCXMaterial.Grossular, 1), GTCXMaterialGen.getTinyDust(GTCXMaterial.Titanium, 1));
            addCrushedOreRecipes(GTCXMaterial.Platinum, GTCXMaterialGen.getTinyDust(GTCXMaterial.Sulfur, 2), GTCXMaterialGen.getTinyDust(GTCXMaterial.Nickel, 1));
            addCrushedOreRecipes(GTCXMaterial.Tungsten, GTCXMaterialGen.getTinyDust(GTCXMaterial.Manganese, 1), GTMaterialGen.getModItem(GTHelperMods.IC2_EXTRAS, "silvertinydust"));
            addCrushedOreRecipes(GTCXMaterial.Iridium, GTCXMaterialGen.getTinyDust(GTCXMaterial.Platinum, 1), GTCXMaterialGen.getTinyDust(GTCXMaterial.Osmium, 1));
            ...
            GTRecipeProcessing.maceratorUtil("orePyrite", 1, GTCXMaterialGen.getCrushedOre(GTCXMaterial.Pyrite, 5));
            ...
            GTRecipeProcessing.maceratorUtil("orePlatinum", 1, GTCXMaterialGen.getCrushedOre(GTCXMaterial.Platinum, 2));
            GTRecipeProcessing.maceratorUtil("oreTungstate", 1, GTCXMaterialGen.getCrushedOre(GTCXMaterial.Tungsten, 2));
            ClassicRecipes.macerator.removeRecipe(input("oreBauxite", 1));
            TileEntityMacerator.addRecipe("oreBauxite", 1, GTCXMaterialGen.getCrushedOre(GTCXMaterial.Bauxite, 4));
            ClassicRecipes.macerator.removeRecipe(input("oreIridium", 1));
            TileEntityMacerator.addRecipe("oreIridium", 1, GTCXMaterialGen.getCrushedOre(GTCXMaterial.Iridium, 2));
            GameRegistry.addSmelting(GTCXMaterialGen.getCrushedOre(GTCXMaterial.Tetrahedrite, 1), GTCXMaterialGen.getNugget(GTCXMaterial.Copper, 10), 0.5F);
