...
public class GTCXRecipeProcessing {
    ...
    public static void initCentrifugeRecipes(){
        ...
        GTTileCentrifuge.addRecipe(GTMaterialGen.getDust(GTMaterial.Basalt, 16), 0, totalCentrifugeEu(24000), GTMaterialGen.getDust(GTCXMaterial.Olivine, 1), GTMaterialGen.getDust(GTMaterial.Calcite, 3), GTMaterialGen.getDust(GTMaterial.Flint, 8), GTMaterialGen.getDust(GTMaterial.Carbon, 1));
