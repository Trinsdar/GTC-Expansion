...
public class GTCXRecipeProcessing {
    ...
    public static void initCentrifugeRecipes(){
        ...
        GTTileCentrifuge.addRecipe(GTMaterialGen.getDust(GTCXMaterial.DarkAshes, 2), 0, totalCentrifugeEu(1250), GTMaterialGen.getDust(GTCXMaterial.Ashes, 1), GTMaterialGen.getDust(GTCXMaterial.Carbon, 1));
