...
public class GTCXJeiDistillationTowerCategory implements IRecipeCategory<GTCXJeiDistillationTowerWrapper> {

    protected String name, displayName;
    protected ResourceLocation backgroundTexture;
    private IDrawable background, progress;

    public GTCXJeiDistillationTowerCategory(IGuiHelper helper, String name, Block block) {
        this.name = name;
    ...
    @Override
    public void setRecipe(IRecipeLayout layout, GTCXJeiDistillationTowerWrapper wrapper, IIngredients ingredients) {
