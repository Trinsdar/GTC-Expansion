...
public class GEJeiDistillationTowerWrapper implements IRecipeWrapper {

    private GTRecipeMultiInputList.MultiRecipe multiRecipe;

    public GEJeiDistillationTowerWrapper(GTRecipeMultiInputList.MultiRecipe multiRecipe) {
