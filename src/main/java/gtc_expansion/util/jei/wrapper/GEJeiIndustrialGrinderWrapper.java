...
public class GEJeiIndustrialGrinderWrapper implements IRecipeWrapper {

    private GTRecipeMultiInputList.MultiRecipe multiRecipe;

    public GEJeiIndustrialGrinderWrapper(GTRecipeMultiInputList.MultiRecipe multiRecipe) {
