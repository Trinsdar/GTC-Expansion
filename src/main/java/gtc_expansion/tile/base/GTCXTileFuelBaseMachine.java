...
public abstract class GTCXTileFuelBaseMachine extends TileEntityMachine implements ITickable, IFuelMachine, IProgressMachine, IHasGui, INetworkTileEntityEventListener {
    @NetworkField(
            index = 3
    )
    public int fuel = 0;
    ...
    public GTCXTileFuelBaseMachine(int slots, int maxProgress, int fuelPerTick) {
        super(slots);
