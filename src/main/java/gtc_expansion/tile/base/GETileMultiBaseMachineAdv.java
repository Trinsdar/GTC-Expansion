...
public abstract class GETileMultiBaseMachineAdv extends GTTileBaseMachine implements IMetaDelegate {
    public boolean lastState;
    public boolean firstCheck = true;
    List<IEnergyTile> lastPositions = null;

    public GETileMultiBaseMachineAdv(int slots, int upgrades, int defaultinput, int maxinput) {
