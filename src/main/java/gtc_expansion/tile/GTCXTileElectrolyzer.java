...
public class GTCXTileElectrolyzer extends GTTileBaseMachine {
    ...
    public static void init() {
        ...
        addRecipe(GTMaterialGen.getTube(GTCXMaterial.SulfuricAcid, 7), 0, totalEu(35280), GTMaterialGen.getTube(GTMaterial.Hydrogen, 2), GTMaterialGen.getTube(GTMaterial.Oxygen, 2), GTMaterialGen.getDust(GTCXMaterial.Sulfur, 1), GTMaterialGen.get(GTItems.testTube, 3));
