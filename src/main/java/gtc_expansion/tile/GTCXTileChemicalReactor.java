...
public class GTCXTileChemicalReactor extends GTTileBaseMachine {
    ...
    public static void init() {
        addRecipe(input(GTMaterialGen.getTube(GTMaterial.Calcium, 1)), input("dustCarbon", 1), 7500, GTMaterialGen.getDust(GTCXMaterial.Calcite, 2), GTMaterialGen.get(GTItems.testTube));
        ...
        addRecipe(input(GTMaterialGen.getDust(GTCXMaterial.Sulfur, 1)), input(GTMaterialGen.getModdedTube("water", 2)), 1, 34500, GTMaterialGen.getTube(GTCXMaterial.SulfuricAcid, 3));
