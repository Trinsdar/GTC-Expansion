...
public class GTCXTileMultiIndustrialGrinder extends GTTileMultiBaseMachine implements ITankListener, IClickable {
    ...
    public static void init(){
        ...
        if (Loader.isModLoaded(GTHelperMods.IC2_EXTRAS) && GTConfig.compatIc2Extras){
            ...
            addWaterRecipe("oreGold", 1, totalEu(12800), GTMaterialGen.getModItem(modid, "goldpurifiedcrushedore", 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Copper, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            addWaterRecipe("oreCopper", 1, totalEu(12800), GTMaterialGen.getModItem(modid, "copperpurifiedcrushedore", 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Gold, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            ...
            addWaterRecipe("oreCassiterite", 1, totalEu(12800), GTMaterialGen.getModItem(modid, "tinpurifiedcrushedore", 4), GTCXMaterialGen.getSmallDust(GTCXMaterial.Carbon, 1));
            ...
            addWaterRecipe("oreGalena", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Galena, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Sulfur, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Silver, 1));
            addWaterRecipe("oreIridium", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Iridium, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Platinum, 2));
            addWaterRecipe("oreBauxite", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Bauxite, 4), GTMaterialGen.getDust(GTCXMaterial.Aluminium, 1));
            addWaterRecipe("orePyrite", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Pyrite, 5), GTMaterialGen.getDust(GTCXMaterial.Sulfur, 2));
            ...
            addWaterRecipe("oreTungstate", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Tungsten, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Iron, 3), GTCXMaterialGen.getSmallDust(GTCXMaterial.Manganese, 3));
            addWaterRecipe("oreSheldonite", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Platinum, 2), GTMaterialGen.getDust(GTCXMaterial.Nickel, 1), GTCXMaterialGen.getNugget(GTCXMaterial.Iridium, 2));
            addMercuryRecipe("oreIridium", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Iridium, 2), GTMaterialGen.getDust(GTCXMaterial.Platinum, 1));
            addMercuryRecipe("oreSheldonite", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Platinum, 3), GTMaterialGen.getDust(GTCXMaterial.Nickel, 1), GTCXMaterialGen.getNugget(GTCXMaterial.Iridium, 2));
            addMercuryRecipe("oreGalena", 1, totalEu(12800), GTCXMaterialGen.getPurifiedCrushedOre(GTCXMaterial.Galena, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Sulfur, 1), Ic2Items.silverDust);
            ...
            addMercuryRecipe("oreGold", 1, totalEu(12800), GTMaterialGen.getModItem(modid, "goldpurifiedcrushedore", 3), GTCXMaterialGen.getSmallDust(GTCXMaterial.Copper, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            ...
            addWaterRecipe("oreUranium", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Uranium, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Plutonium, 1));
            ...
            addWaterRecipe("oreIron", 1, totalEu(12800), GTMaterialGen.getIc2(Ic2Items.ironDust, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Tin, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            addWaterRecipe("oreGold", 1, totalEu(12800), GTMaterialGen.getIc2(Ic2Items.goldDust, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Copper, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            addWaterRecipe("oreCopper", 1, totalEu(12800), GTMaterialGen.getIc2(Ic2Items.copperDust, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Gold, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
            ...
            addWaterRecipe("oreCassiterite", 1, totalEu(12800), GTMaterialGen.getIc2(Ic2Items.tinDust, 4), GTCXMaterialGen.getSmallDust(GTCXMaterial.Carbon, 1));
            ...
            addWaterRecipe("oreGalena", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Galena, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Sulfur, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Silver, 1));
            addWaterRecipe("oreIridium", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Iridium, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Platinum, 2));
            addWaterRecipe("oreBauxite", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Bauxite, 4), GTMaterialGen.getDust(GTCXMaterial.Aluminium, 1));
            addWaterRecipe("orePyrite", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Pyrite, 5), GTMaterialGen.getDust(GTCXMaterial.Sulfur, 2));
            ...
            addWaterRecipe("oreTungstate", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Tungsten, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Iron, 3), GTCXMaterialGen.getSmallDust(GTCXMaterial.Manganese, 3));
            addWaterRecipe("oreSheldonite", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Platinum, 2), GTMaterialGen.getDust(GTCXMaterial.Nickel, 1), GTCXMaterialGen.getNugget(GTCXMaterial.Iridium, 2));
            addMercuryRecipe("oreIridium", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Iridium, 2), GTMaterialGen.getDust(GTCXMaterial.Platinum, 1));
            addMercuryRecipe("oreSheldonite", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Platinum, 3), GTMaterialGen.getDust(GTCXMaterial.Nickel, 1), GTCXMaterialGen.getNugget(GTCXMaterial.Iridium, 2));
            addMercuryRecipe("oreGalena", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Galena, 2), GTCXMaterialGen.getSmallDust(GTCXMaterial.Sulfur, 1), Ic2Items.silverDust);
            ...
            addMercuryRecipe("oreGold", 1, totalEu(12800), GTMaterialGen.getIc2(Ic2Items.goldDust, 3), GTCXMaterialGen.getSmallDust(GTCXMaterial.Copper, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Nickel, 1));
        ...
        addWaterRecipe("oreRuby", 1, totalEu(12800), GTMaterialGen.getGem(GTCXMaterial.Ruby, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Ruby, 6), GTCXMaterialGen.getSmallDust(GTCXMaterial.GarnetRed, 2));
        addWaterRecipe("oreSapphire", 1, totalEu(12800), GTMaterialGen.getGem(GTCXMaterial.Sapphire, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Sapphire, 6), GTCXMaterialGen.getSmallDust(GTCXMaterial.Aluminium, 2));
        ...
        addWaterRecipe("oreCoal", 1, totalEu(12800), GTMaterialGen.get(Items.COAL), Ic2Items.coalDust, GTCXMaterialGen.getSmallDust(GTCXMaterial.Thorium, 1));
        addWaterRecipe("oreLapis", 1, totalEu(12800), new ItemStack(Items.DYE, 12, 4), GTMaterialGen.getDust(GTCXMaterial.Lazurite, 3));
        ...
        addWaterRecipe("oreEmerald", 1, totalEu(12800), GTMaterialGen.get(Items.EMERALD), GTCXMaterialGen.getSmallDust(GTCXMaterial.Emerald, 6), GTCXMaterialGen.getSmallDust(GTCXMaterial.Olivine, 2));
        addWaterRecipe("oreOlivine", 1, totalEu(12800), GTMaterialGen.getGem(GTCXMaterial.Olivine, 1), GTCXMaterialGen.getSmallDust(GTCXMaterial.Olivine, 6), GTCXMaterialGen.getSmallDust(GTCXMaterial.Emerald, 2));
        addWaterRecipe("oreSodalite", 1, totalEu(12800), GTMaterialGen.getDust(GTCXMaterial.Sodalite, 12), GTMaterialGen.getDust(GTCXMaterial.Aluminium, 3));
