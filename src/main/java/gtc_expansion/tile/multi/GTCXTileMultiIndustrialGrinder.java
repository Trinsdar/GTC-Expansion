...
public class GTCXTileMultiIndustrialGrinder extends GTTileMultiBaseMachine implements ITankListener, IClickable, IGTDebuggableTile {
    ...
    public static void init(){
        ...
        addWaterRecipe("oreBauxite", 1, totalEu(12800), GTCXRecipeProcessing.getPurifiedOrDust(GTMaterial.Bauxite, 2), GTMaterialGen.getDust(GTMaterial.Aluminium, 1));
        ...
        addRecipe("oreBauxite", 1, GTMaterialGen.getFluidStack(GTCXMaterial.SulfuricAcid), totalEu(12720),GTCXRecipeProcessing.getPurifiedOrDust(GTMaterial.Bauxite, 2), GTMaterialGen.getDust(GTMaterial.Aluminium, 1), GTCXMaterialGen.getSmallDust(GTMaterial.Titanium, 1));
