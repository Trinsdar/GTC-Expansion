...
public class GTCXTileAlloySmelter extends GTTileBaseMachine {
    ...
    public static void init() {
        ...
        addAlloyRecipe("Nickel", 4, "Chrome", 1, GTMaterialGen.getIngot(GTCXMaterial.Nichrome, 5));
    }
    ...
    static void addRecipe(List<IRecipeInput> input, MachineOutput output) {
        GTCXRecipeLists.ALLOY_SMELTER_RECIPE_LIST.addRecipe(input, output, output.getAllOutputs().get(0).getUnlocalizedName(), 16);
    }
}
